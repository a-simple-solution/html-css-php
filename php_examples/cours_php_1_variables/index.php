...
<body>
    ...
    <main>
        ...
        $titre = "<h1>Titre Accueil en PHP</h1>";
        $paragraphe = "<h1>Titre Accueil en PHP</h1>";
        $sous_paragraphe = "<h1>Titre Accueil en PHP</h1>";
        $sous_sous_paragraphe = "<h1>Titre Accueil en PHP</h1>";

        /* Echo me permet d'afficher cette variable */
        /* https://www.php.net/manual/en/function.echo.php */
        echo $titre;
        echo $paragraphe;
        echo $sous_paragraphe;
        echo $sous_sous_paragraphe;
